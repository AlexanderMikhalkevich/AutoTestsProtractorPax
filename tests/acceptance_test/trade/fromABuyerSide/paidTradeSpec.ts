    ...
    describe("Paid trade", () => {
        ...
        it("shows the Dispute button and its descriptions id6547", async () => {
            expect(await tradePO.elements.disputeButton.getText()).toMatch(
                /Dispute available in 2:5[7-9]:[0-5][0-9]/,
            );
        ...
        it("does not show the Paid button and its description id6548", async () => {
            expect(await tradePO.elements.paidButton.isDisplayed()).toBeFalsy(
                "Paid button shuold not be shown",
            );
            expect(await tradePO.elements.paidButtonDescription.isDisplayed()).toBeFalsy(
        ...
        it("allows to click the report a problem link and see the report modal id6531", async () => {
            ...
            expect(
                await tradePO.elements.reportTradeModalTypeSelectSelectedOption.getText(),
        ...
        it("allows to see some additional info about trade report types id6532", async () => {
            ...
            await browser.sleep(1000); // can't call sendKeys too often for the same field
            await tradePO.elements.reportTradeModalTypeSelect.click();
        ...
        it("allows to close the report a problem modal id6533", async () => {
            ...
            expect(await tradePO.elements.reportTradeModal.isDisplayed()).toBeFalsy();
        });
